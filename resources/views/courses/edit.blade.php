                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('courses.update', $course->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="credits" id="credits" value="{{ old('credits', $course->credits) }}" min="1" max="255"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="semester" id="semester" value="{{ old('semester', $course->semester) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="robotics_kit_id" id="robotics_kit_id"
                                ...
                                @foreach($roboticsKits as $kit)
                                    <option value="{{ $kit->id }}"
                                        {{ old('robotics_kit_id', $course->robotics_kit_id) == $kit->id ? 'selected' : '' }}>
                                        {{ $kit->name }}
                                    </option>
                                @endforeach
                            </select>
